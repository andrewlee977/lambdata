...
- An important part of code reviews is ensuring readability. It's important for your code to be reproducible, and giving/receiving feedback from someone that finds this important is crucial. I think it's important to also notice how someone went about attacking a problem. How they approach the problem they are trying to solve greatly impacts the complexity of the code. Sometimes all it takes is a simple solution. Having docstrings is also something to look out for in code reviews!
- Containers essentially standardize everything by ensuring all the dependencies are in one place. This makes it easier for these containers to be sent between teams and worked on with different operating systems. The container interacts with the operating system, so anyone can work on it, regardless of OS. You can deliver a container to anyone and it will have all the required dependencies, this is clearly a scalable solution to coding, rather than using a notebook.
