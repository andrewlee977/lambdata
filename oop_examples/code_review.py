...
# what would you say if you were working with someone and this is the
# code they gave you?
...
def exampl1():
    ...
    # character limit
    some_tuple = (1, 2, 3, 'a')
    some_variable = {"long": "LONG CODE LINES should be wrapped"
                    "within 79 character to prevent page cutoff stuff",
